...
func (c *gStringServiceClient) MSet(ctx context.Context, in *MSetRequest, opts ...grpc.CallOption) (*MSetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gstring.GStringService/MSet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gStringServiceClient) MSetNX(ctx context.Context, in *MSetNXRequest, opts ...grpc.CallOption) (*MSetNXResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gstring.GStringService/MSetNX", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gStringServiceClient) TTL(ctx context.Context, in *TTLRequest, opts ...grpc.CallOption) (*TTLResponse, error) {
	out := new(TTLResponse)
	err := c.cc.Invoke(ctx, "/gstring.GStringService/TTL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gStringServiceClient) Keys(ctx context.Context, in *KeysRequest, opts ...grpc.CallOption) (*KeysResponse, error) {
	out := new(KeysResponse)
	err := c.cc.Invoke(ctx, "/gstring.GStringService/Keys", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gStringServiceClient) Size(ctx context.Context, in *SizeRequest, opts ...grpc.CallOption) (*SizeResponse, error) {
	out := new(SizeResponse)
	err := c.cc.Invoke(ctx, "/gstring.GStringService/Size", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGStringServiceServer) TTL(context.Context, *TTLRequest) (*TTLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TTL not implemented")
}
func (UnimplementedGStringServiceServer) Keys(context.Context, *KeysRequest) (*KeysResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Keys not implemented")
}
func (UnimplementedGStringServiceServer) Size(context.Context, *SizeRequest) (*SizeResponse, error) {
...
func _GStringService_MSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gstring.GStringService/MSet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GStringService_MSetNX_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gstring.GStringService/MSetNX",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GStringService_TTL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TTLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GStringServiceServer).TTL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gstring.GStringService/TTL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GStringServiceServer).TTL(ctx, req.(*TTLRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GStringService_Keys_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KeysRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GStringServiceServer).Keys(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gstring.GStringService/Keys",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GStringServiceServer).Keys(ctx, req.(*KeysRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GStringService_Size_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SizeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GStringServiceServer).Size(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gstring.GStringService/Size",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GStringServiceServer).Size(ctx, req.(*SizeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GStringService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TTL",
			Handler:    _GStringService_TTL_Handler,
		},
		{
			MethodName: "Keys",
			Handler:    _GStringService_Keys_Handler,
		},
		{
			MethodName: "Size",
			Handler:    _GStringService_Size_Handler,
		},
	},
