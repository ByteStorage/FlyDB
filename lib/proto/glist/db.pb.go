...
func (x *GListLPushRequest) Reset() {
	*x = GListLPushRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_lib_proto_glist_db_proto_msgTypes[0]
...
func (*GListLPushRequest) Descriptor() ([]byte, []int) {
	return file_lib_proto_glist_db_proto_rawDescGZIP(), []int{0}
}
...
func (*GListLPushResponse) Descriptor() ([]byte, []int) {
	return file_lib_proto_glist_db_proto_rawDescGZIP(), []int{1}
}
